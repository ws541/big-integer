...
速度比专业库慢 3 到 13 倍，超大数字渐进行为良好。以下是部分测试结果（测试代码见 full_test.cpp）。
...
数论方面函数因为小数字 heavy 慢；二次筛法和 Index Calculus 进一步因为没有线性代数支持、光滑界保守，差距可达几百倍。
